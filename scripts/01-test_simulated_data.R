#### Preamble ####
# Purpose: To validate the integrity and consistency of the simulated beef dataset through a series of unit tests, ensuring accurate data loading, logical constraints, and adherence to expected value ranges.
# Author: Ziheng Zhong
